...
| Эвристика | `.text` weighted best | Instruction weighted best | Better than `-Oz` | total best delta | mean real evals |
|---|---:|---:|---:|---:|---:|
| `measured_superpath` | **7.4816%** | **8.7662%** | **25/30** | **77292** | 1254 |
| `random_walk_top1000` | 6.9315% | 8.0048% | 23/30 | 71609 | ~1000 |
...
| `-Oz` (baseline) | 1.7836% | n/a | n/a | n/a | n/a |
